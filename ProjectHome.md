opensource threadpool,you may find it's used like Java or C#,but it's C++ ,so it's wow !
You can use it freely,and you can post your idea to this project,let us make it better.for more details please read wiki/readme file.

http://sourceforge.net/projects/tinythreadpool/files/tinythreadpool-1.0.1.tar.gz sha1: 5ea9025f5b29a60099a6c0eae56f21ab70e87f3d

Here are some examples for the usage of the thread pool.
```
#include <iostream>
#include <sstream>
